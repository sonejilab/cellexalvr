...
namespace VRTK.GrabAttachMechanics
{
	...
	/// </example>
	public class GraphGrabAttach : VRTK_BaseJointGrabAttach
	{
		...
		{
			base.CreateJoint (obj.transform.parent.gameObject);
		}

		public override bool StartGrab(GameObject grabbingObject, GameObject givenGrabbedObject, Rigidbody givenControllerAttachPoint)
		{
			return base.StartGrab (grabbingObject, givenGrabbedObject.transform.parent.gameObject, givenControllerAttachPoint);
		}
	}
}