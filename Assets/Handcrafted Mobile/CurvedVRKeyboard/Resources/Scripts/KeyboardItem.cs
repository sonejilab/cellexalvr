...
namespace CurvedVRKeyboard
{
    public class KeyboardItem : KeyboardComponent
    {
        ...
        public void SetMaterials(Material keyNormalMaterial, Material keySelectedMaterial, Material keyPressedMaterial, Material keyTextMaterial, Font keyFont)
        {
            ...
            letter.font = keyFont;
            letter.material = keyTextMaterial;
